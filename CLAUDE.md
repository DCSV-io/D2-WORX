...
| [FILES_APP.md](backends/node/services/files/app/FILES_APP.md)                                                              | Files app layer: 11 CQRS handlers (6C/4Q/1U), 33 service keys, context key config, provider/repo/outbound/realtime interfaces, DI registration                                                            | Files handler work, upload/processing pipeline  |
