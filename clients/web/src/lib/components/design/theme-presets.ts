...
export const builtInPresets: ThemePreset[] = [
  ...
  {
    // Cool blue-gray — popular in developer tools (GitHub, Linear)
    name: "Slate",
    primaryHue: 230,
    primaryChroma: 0.06,
    primaryLightness: 0.4,
    secondaryHue: 215,
  ...
  {
    // Warm but restrained — burnt umber primary, amber gold accent, mature SaaS feel
    name: "Ember",
    primaryHue: 20,
    primaryChroma: 0.08,
    primaryLightness: 0.42,
    secondaryHue: 35,
    secondaryChroma: 0.06,
    secondaryLightness: 0.48,
    accentHue: 45,
    accentChroma: 0.14,
