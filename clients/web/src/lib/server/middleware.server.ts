 ...
 *
 * Hard-fails if required env vars are missing — the back-end infrastructure
 * must always be running (Redis, Geo service).
 *
 ...
 * Throws if required env vars are missing — infrastructure is required in all environments.
 */
