...
`DistributedCache.Redis` — 6 handlers (Get, Set, Remove, Exists, GetTtl, Increment) using `IDistributedCache` or `IConnectionMultiplexer`. Node.js version uses `ioredis` directly.
