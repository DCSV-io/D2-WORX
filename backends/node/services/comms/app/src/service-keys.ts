...
import type { UpsertTemplate } from "./implementations/cqrs/handlers/c/upsert-template.js";
import type { GetChannelPreference } from "./implementations/cqrs/handlers/q/get-channel-preference.js";
import type { GetTemplate } from "./implementations/cqrs/handlers/q/get-template.js";
import type { HandleVerificationEmail } from "./implementations/messaging/handlers/sub/handle-verification-email.js";
import type { HandlePasswordReset } from "./implementations/messaging/handlers/sub/handle-password-reset.js";
import type { HandleInvitationEmail } from "./implementations/messaging/handlers/sub/handle-invitation-email.js";
...
export const IFindChannelPreferenceByUserIdKey =
  createServiceKey<IFindChannelPreferenceByUserIdHandler>(
    "Comms.Repo.FindChannelPreferenceByUserId",
  );
...
export const ICreateTemplateWrapperRecordKey =
  createServiceKey<ICreateTemplateWrapperRecordHandler>("Comms.Repo.CreateTemplateWrapperRecord");
export const IFindTemplateByNameAndChannelKey =
  createServiceKey<IFindTemplateByNameAndChannelHandler>("Comms.Repo.FindTemplateByNameAndChannel");
export const IUpdateTemplateWrapperRecordKey =
  createServiceKey<IUpdateTemplateWrapperRecordHandler>("Comms.Repo.UpdateTemplateWrapperRecord");
...
export const IUpsertTemplateKey = createServiceKey<UpsertTemplate>("Comms.App.UpsertTemplate");

// --- Query Handlers ---
export const IGetChannelPreferenceKey = createServiceKey<GetChannelPreference>(
  "Comms.App.GetChannelPreference",
);
export const IGetTemplateKey = createServiceKey<GetTemplate>("Comms.App.GetTemplate");

// --- Messaging Sub Handlers ---
export const IHandleVerificationEmailKey = createServiceKey<HandleVerificationEmail>(
  "Comms.App.HandleVerificationEmail",
);
export const IHandlePasswordResetKey = createServiceKey<HandlePasswordReset>(
  "Comms.App.HandlePasswordReset",
);
export const IHandleInvitationEmailKey = createServiceKey<HandleInvitationEmail>(
  "Comms.App.HandleInvitationEmail",
);
