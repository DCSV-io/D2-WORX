...
using D2.Shared.DatabaseStartup.Pg;
...
// Get required connection strings from env vars (set via .env.local / Docker Compose).
...
{
    await DatabaseHelper.EnsureDatabaseExistsAsync(
        dbConnectionString,
