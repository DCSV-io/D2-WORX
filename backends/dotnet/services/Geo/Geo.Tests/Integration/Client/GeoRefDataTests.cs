...
public class GeoRefDataTests : IAsyncLifetime
{
    ...
    public async ValueTask Get_WithDataInRedis_SucceedsAndCachesInMemoryAndOnDisk()
    {
        ...
        Assert.Equal(ClientTestHelpers.TestGeoRefData.Version, memResult.Data!.Data.Version);
        ...
        Assert.Equal(ClientTestHelpers.TestGeoRefData.Version, diskResult.Data!.Data.Version);
    }
    ...
    public async ValueTask Get_WithDataInMemory_SucceedsImmediately()
    {
        ...
        await setInMemHandler.HandleAsync(
            new(ClientTestHelpers.TestGeoRefData),
            Ct);
        ...
        // Assert
        Assert.True(result.Success);
        Assert.Equal(ClientTestHelpers.TestGeoRefData.Version, result.Data!.Data.Version);
    }
