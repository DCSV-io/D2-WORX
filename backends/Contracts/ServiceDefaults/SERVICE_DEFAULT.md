...
| [Extensions.IHostApplicationBuilder.cs](Extensions.IHostApplicationBuilder.cs) | Internal implementation configuring Serilog (console + Loki sink), OpenTelemetry tracing/metrics (ASP.NET Core, gRPC, HTTP client, runtime, process), Prometheus exporter, OTLP trace exporter, and health checks. Filters out infrastructure endpoints (/health, /alive, /metrics) from traces and logs. |
