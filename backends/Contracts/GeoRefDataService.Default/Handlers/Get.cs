...
using H = D2.Contracts.Interfaces.GeoRefDataService.IGeoRefDataService.IGetHandler;
using I = D2.Contracts.Interfaces.GeoRefDataService.IGeoRefDataService.GetInput;
using O = D2.Contracts.Interfaces.GeoRefDataService.IGeoRefDataService.GetOutput;
...
public class Get : BaseHandler<Get, I, O>, H
{
    ...
    /// </param>
    public Get(
        IGeoRefDataService.IGetFromMemHandler getFromMem,
        IGeoRefDataService.IGetFromDistHandler getFromDist,
        IGeoRefDataService.ISetInMemHandler setInMem,
        IGeoRefDataService.ISetOnDiskHandler setOnDisk,
        IGeoRefDataService.IGetFromDiskHandler getFromDisk,
        IGeoRefDataService.IReqUpdateHandler requestUpdate,
