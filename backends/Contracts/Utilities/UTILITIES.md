...
Shared utility extensions and helpers used across all contracts and services. Provides string cleaning, collection operations, GUID validation, and content-addressable hashing.
